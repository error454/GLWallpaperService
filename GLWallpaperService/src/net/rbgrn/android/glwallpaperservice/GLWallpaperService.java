...
//            Log.d(TAG, "onSurfaceDestroyed()");
        ...
        public void setRenderer(Renderer renderer) {
            ...
            if (mEGLConfigChooser == null) {
                ...
                int iPreferedAlphaSize  = 8 ;
                int iPreferedDepthSize  = 16 ;
                int iPreferedStencilSize =  8; 
                    
//                Globals.mSurfaceHolder.setFormat ( PixelFormat.TRANSLUCENT ) ;
                
//                mEGLConfigChooser = new SimpleEGLConfigChooser(true);
                mEGLConfigChooser = new S3DConfigChooserGLES2Wallpaper ( iPreferedRedSize, iPreferedGreenSize, iPreferedBlueSize, iPreferedAlphaSize, iPreferedDepthSize, iPreferedStencilSize );
            }
            if (mEGLContextFactory == null) {
//                mEGLContextFactory = new DefaultContextFactory();
                mEGLContextFactory = new S3DContextFactoryGLES2Wallpaper();
            }
...
class S3DContextFactoryGLES2Wallpaper implements EGLContextFactory 
{
...
class S3DConfigChooserGLES2Wallpaper implements EGLConfigChooser 
{
    private static final boolean DEBUG = false;
    
    public S3DConfigChooserGLES2Wallpaper ( int r, int g, int b, int a, int depth, int stencil ) 
    {
        mRedSize        = r;
        mGreenSize      = g;
        mBlueSize       = b;
...
//        Log.i("EGL", "Destroyed mEglSurface");
        if (mEglSurface != null && mEglSurface != EGL10.EGL_NO_SURFACE) {
            mEgl.eglMakeCurrent(mEglDisplay, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_CONTEXT);
            mEGLWindowSurfaceFactory.destroySurface(mEgl, mEglDisplay, mEglSurface);
            mEglSurface = null;
